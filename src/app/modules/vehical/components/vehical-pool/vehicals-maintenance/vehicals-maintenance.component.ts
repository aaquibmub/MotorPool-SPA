...
@Component({
  selector: 'app-vehicals-maintenance',
  templateUrl: './vehicals-maintenance.component.html',
  styleUrls: ['./vehicals-maintenance.component.css']
})
export class VehicalsMaintenanceComponent implements OnInit, OnDestroy {
    ...
    this.pageSizeSubscription = this.gridToolbarService.getPageSize()
      .subscribe(
        (pageSize: number) => {
          ...
          this.vehicalService.fetchGridData(this.state, this.searchQuery, VehicalStatus.Maintenance);
        }
      );
  ...
  dataStateChange(state: DataStateChangeEvent): void {
    this.state = state;
    this.vehicalService.fetchGridData(state, this.searchQuery, VehicalStatus.Maintenance);
  }
