...
@Component({
  selector: 'app-vehical-inspection-completed',
  templateUrl: './vehical-inspection-completed.component.html',
  styleUrls: ['./vehical-inspection-completed.component.css']
})
export class VehicalInspectionCompletedComponent implements OnInit, OnDestroy {
      ...
      .subscribe(
        (pageSize: number) => {
          ...
          this.vehicalService.fetchVehicalInspectionByStatusGridData(
            this.state, this.searchQuery, VehicalInspectionStatus.Completed);
        }
      );
  ...
  dataStateChange(state: DataStateChangeEvent): void {
    this.state = state;
    this.vehicalService.fetchVehicalInspectionByStatusGridData(
      state, this.searchQuery, VehicalInspectionStatus.Completed);
  }
