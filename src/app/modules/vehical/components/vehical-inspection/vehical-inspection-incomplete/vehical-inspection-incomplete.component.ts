...
@Component({
  selector: 'app-vehical-inspection-incomplete',
  templateUrl: './vehical-inspection-incomplete.component.html',
  styleUrls: ['./vehical-inspection-incomplete.component.css']
})
export class VehicalInspectionIncompleteComponent implements OnInit, OnDestroy {
      ...
      .subscribe(
        (pageSize: number) => {
          ...
          this.vehicalService.fetchVehicalInspectionByStatusGridData(
            this.state, this.searchQuery, VehicalInspectionStatus.Incomplete);
        }
      );
  ...
  dataStateChange(state: DataStateChangeEvent): void {
    this.state = state;
    this.vehicalService.fetchVehicalInspectionByStatusGridData(
      state, this.searchQuery, VehicalInspectionStatus.Incomplete);
  }
