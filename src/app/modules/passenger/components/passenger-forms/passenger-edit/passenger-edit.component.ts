...
import { PassangerTypeService } from 'src/app/helper/services/passanger/passanger-type.service';
...
export class PassengerEditComponent implements OnInit {
  ...
  constructor(
    ...
    private passangerTypeSerice: PassangerTypeService,
  ...
  private initForm(): void {
    ...
    let passangerIdStr: string = '<auto-generated>';
    ...
    this.form = new UntypedFormGroup({
      passangerIdStr: new UntypedFormControl(
        passangerIdStr, [Validators.required]),
