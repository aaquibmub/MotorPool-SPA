...
@Component({
  selector: 'app-report-vehicle-milage',
  templateUrl: './report-vehicle-milage.component.html',
  styleUrls: ['./report-vehicle-milage.component.css']
})
export class ReportVehicleMilageComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.gridFilterSubscription = this.gridToolbarService.getGridFilter()
      .subscribe(
        (show: boolean) => {
          ...
          this.reportService.fetchVehicleMilageGridData(this.state, this.searchQuery);
        }
      );
    ...
    this.reportService.fetchVehicleMilageGridData(this.state, this.searchQuery);
    this.gridDataSubscription = this.reportService.getVehicleMilageGridData()
      .subscribe(
        (data: any) => {
  ...
  dataStateChange(state: DataStateChangeEvent): void {
    this.state = state;
    this.reportService.fetchVehicleMilageGridData(state, this.searchQuery);
  }
