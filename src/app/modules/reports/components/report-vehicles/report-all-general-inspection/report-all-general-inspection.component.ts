...
@Component({
  selector: 'app-report-all-general-inspection',
  templateUrl: './report-all-general-inspection.component.html',
...
export class ReportAllGeneralInspectionComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.reportService.fetchAllGeneralInspectionGridData(this.state, this.searchQuery);
    this.gridDataSubscription = this.reportService.getAllGeneralInspectionGridData()
      .subscribe(
        (data: any) => {
  ...
  dataStateChange(state: DataStateChangeEvent): void {
    this.state = state;
    this.reportService.fetchAllGeneralInspectionGridData(state, this.searchQuery);
  }
