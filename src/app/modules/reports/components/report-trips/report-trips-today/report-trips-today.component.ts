...
@Component({
  selector: 'app-report-trips-today',
  templateUrl: './report-trips-today.component.html',
  styleUrls: ['./report-trips-today.component.css']
})
export class ReportTripsTodayComponent implements OnInit, OnDestroy {
  grid: GridComponent;
    ...
    this.gridFilterSubscription = this.gridToolbarService.getGridFilter()
      .subscribe(
        (show: boolean) => {
          ...
          this.reportService.fetchAllTripGridData(this.state, this.searchQuery, null, null, TripType.Today);
        }
      );
  ...
  dataStateChange(state: DataStateChangeEvent): void {
    this.state = state;
    this.reportService.fetchAllTripGridData(state, this.searchQuery, null, null, TripType.Today);
  }
