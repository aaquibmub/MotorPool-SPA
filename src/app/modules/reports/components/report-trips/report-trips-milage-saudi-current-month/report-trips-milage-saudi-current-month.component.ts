...
@Component({
  selector: 'app-report-trips-milage-saudi-current-month',
  templateUrl: './report-trips-milage-saudi-current-month.component.html',
  styleUrls: ['./report-trips-milage-saudi-current-month.component.css']
})
export class ReportTripsMilageSaudiCurrentMonthComponent implements OnInit, OnDestroy {
  grid: GridComponent;
    ...
    this.pageSizeSubscription = this.gridToolbarService.getPageSize()
      .subscribe(
        (pageSize: number) => {
          ...
          this.reportService.fetchTripMilageGridData(this.state, this.searchQuery, TripType.CurrentMonth, OPM.SaudiSide);
        }
      );
  ...
  dataStateChange(state: DataStateChangeEvent): void {
    this.state = state;
    this.reportService.fetchTripMilageGridData(state, this.searchQuery, TripType.CurrentMonth, OPM.SaudiSide);
  }
