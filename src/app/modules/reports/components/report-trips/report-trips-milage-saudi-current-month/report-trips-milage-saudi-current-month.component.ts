...
export class ReportTripsMilageSaudiCurrentMonthComponent implements OnInit, OnDestroy {
      ...
      .subscribe(
        (show: boolean) => {
          ...
          this.reportService.fetchTripMilageGridData(
            this.state, this.searchQuery, this.aggregates, TripType.CurrentMonth, OPM.SaudiSide);
        }
      );
  ...
  dataStateChange(state: DataStateChangeEvent): void {
    this.state = state;
    this.reportService.fetchTripMilageGridData(
      state, this.searchQuery, this.aggregates, TripType.CurrentMonth, OPM.SaudiSide);
  }
