...
@Component({
  selector: 'app-report-trips-milage-saudi-today',
  templateUrl: './report-trips-milage-saudi-today.component.html',
  styleUrls: ['./report-trips-milage-saudi-today.component.css']
})
export class ReportTripsMilageSaudiTodayComponent implements OnInit, OnDestroy {
  grid: GridComponent;
    ...
    this.pageSizeSubscription = this.gridToolbarService.getPageSize()
      .subscribe(
        (pageSize: number) => {
          ...
          this.reportService.fetchTripMilageGridData(this.state, this.searchQuery, TripType.Today, OPM.SaudiSide);
        }
      );
  ...
  dataStateChange(state: DataStateChangeEvent): void {
    this.state = state;
    this.reportService.fetchTripMilageGridData(state, this.searchQuery, TripType.Today, OPM.SaudiSide);
  }
