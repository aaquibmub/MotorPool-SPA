...
@Component({
  selector: 'app-report-trips-upcoming',
  templateUrl: './report-trips-upcoming.component.html',
  styleUrls: ['./report-trips-upcoming.component.css']
})
export class ReportTripsUpcomingComponent implements OnInit, OnDestroy {
  grid: GridComponent;
