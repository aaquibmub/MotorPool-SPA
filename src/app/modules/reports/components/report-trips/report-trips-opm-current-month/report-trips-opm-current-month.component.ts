...
@Component({
  selector: 'app-report-trips-opm-current-month',
  templateUrl: './report-trips-opm-current-month.component.html',
  styleUrls: ['./report-trips-opm-current-month.component.css']
})
export class ReportTripsOpmCurrentMonthComponent implements OnInit, OnDestroy {
  grid: GridComponent;
