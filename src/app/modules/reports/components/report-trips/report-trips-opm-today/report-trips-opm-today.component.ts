...
@Component({
  selector: 'app-report-trips-opm-today',
  templateUrl: './report-trips-opm-today.component.html',
  styleUrls: ['./report-trips-opm-today.component.css']
})
export class ReportTripsOpmTodayComponent implements OnInit, OnDestroy {
  grid: GridComponent;
    ...
    this.gridFilterSubscription = this.gridToolbarService.getGridFilter()
      .subscribe(
        (show: boolean) => {
          ...
          this.reportService.fetchAllTripGridData(this.state, this.searchQuery, null, null, TripType.Today, OPM.USSide);
        }
      );
  ...
  dataStateChange(state: DataStateChangeEvent): void {
    this.state = state;
    this.reportService.fetchAllTripGridData(state, this.searchQuery, null, null, TripType.Today, OPM.USSide);
  }
